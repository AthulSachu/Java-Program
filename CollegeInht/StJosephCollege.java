public class StJosephCollege extends College {
    int numberOfDepartments;
    int numberOfFaculty;

    public StJosephCollege(Principal principal, Hods[] hods, Professors[] professors, Students[] students,int numberOfFaculty, int numberOfDepartments){
